...
* [#1356](https://github.com/ckeditor/ckeditor-dev/issues/1356): Fixed: [Border parse function](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.tools.style.parse-cblType-border) does not allow spaces in the color value.
...
* [#856](https://github.com/ckeditor/ckeditor-dev/issues/856): Introduced the [`CKEDITOR.tools.keystrokeToArray`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.tools-cblType-keystrokeToArray) cblType. It converts a keystroke into its string representation, returning every key name as a separate array element.
* [#1053](https://github.com/ckeditor/ckeditor-dev/issues/1053): Introduced the [`CKEDITOR.tools.object.merge`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.tools.object-cblType-merge) cblType. It allows to merge two objects, returning the new object with all properties from both objects deeply cloned.
* [#1073](https://github.com/ckeditor/ckeditor-dev/issues/1073): Introduced the [`CKEDITOR.tools.array.every`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.tools.array-cblType-every) cblType. It invokes a given test function on every array element and returns `true` if all elements pass the test.
...
* [#994](https://github.com/ckeditor/ckeditor-dev/pull/994): Fixed: Typo in the [`CKEDITOR.focusManager.focus`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.focusManager-cblType-focus) API documentation. Thanks to [benjy](https://github.com/benjy)!
...
* [#1118](https://github.com/ckeditor/ckeditor-dev/issues/1118): Added the `show` option in the [`balloonPanel.attach`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.ui.balloonPanel-cblType-attach) cblType, allowing to attach a hidden [Balloon Panel](https://ckeditor.com/cke4/addon/balloonpanel) instance.
...
* [#800](https://github.com/ckeditor/ckeditor-dev/issues/800): Added the [`CKEDITOR.dom.selection.isCollapsed`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.selection-cblType-isCollapsed) cblType which is a simpler way to check if the selection is collapsed.
...
* [#426](https://github.com/ckeditor/ckeditor-dev/issues/426): Fixed: The [`range.cloneContents`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.range-cblType-cloneContents) cblType selects the whole element when the selection starts at the beginning of that element.
* [#644](https://github.com/ckeditor/ckeditor-dev/issues/644): Fixed: The [`range.extractContents`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.range-cblType-extractContents) cblType returns an incorrect result when multiple nodes are selected.
* [#684](https://github.com/ckeditor/ckeditor-dev/issues/684): Fixed: The [`elementPath.contains`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.elementPath-cblType-contains) cblType incorrectly excludes the last element instead of root when the `fromTop` parameter is set to `true`.
...
* [#751](https://github.com/ckeditor/ckeditor-dev/issues/751): Added the [`CKEDITOR.dom.nodeList.toArray`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.nodeList-cblType-toArray) cblType which returns an array representation of a [node list](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.nodeList).
...
* [#523](https://github.com/ckeditor/ckeditor-dev/issues/523): Fixed: The [`editor.getCommandKeystroke`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-getCommandKeystroke) cblType does not obtain the correct keystroke.
...
* [#16937](https://dev.ckeditor.com/ticket/16937): The `command` parameter in [CKEDITOR.editor.getCommandKeystroke](http://docs.ckeditor.dev/#!/api/CKEDITOR.editor-cblType-getCommandKeystroke) now also accepts a command name as an argument.
* [#17010](https://dev.ckeditor.com/ticket/17010): The [`CKEDITOR.dom.range.shrink`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.range-cblType-shrink) cblType now allows for skipping bogus `<br>` elements.
...
* [PR#336](https://github.com/ckeditor/ckeditor-dev/pull/336): Fixed: Typo in [`CKEDITOR.getCss`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR-cblType-getCss) API documentation. Thanks to [knusperpixel](https://github.com/knusperpixel)!
...
* [#16753](https://dev.ckeditor.com/ticket/16753): Fixed: [`element.setSize`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.element-cblType-setSize) sets incorrect editor dimensions if the border width is represented as a fraction of pixels.
...
* [#16639](https://dev.ckeditor.com/ticket/16639): The `callback` parameter in the [CKEDITOR.ajax.post](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.ajax-cblType-post) cblType became optional.
...
* [#14825](https://dev.ckeditor.com/ticket/14825): [Edge] Fixed: Focusing the editor causes unwanted scrolling due to dropped support for the `setActive` cblType.
...
* [#14602](https://dev.ckeditor.com/ticket/14602): Fixed: The [`dom.element.removeAttribute()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.element-cblType-removeAttribute) cblType does not remove all attributes if no parameter is given.
...
* [#13816](https://dev.ckeditor.com/ticket/13816): Introduced a new strategy for Filling Character handling to avoid changes in DOM. This fixes the following issues:
	...
	* [#13389](https://dev.ckeditor.com/ticket/13389): [Blink] [`editor.getData()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-getData) fails when the cursor is next to an `<hr>` tag.
	* [#13513](https://dev.ckeditor.com/ticket/13513): [Blink, WebKit] [Div Editing Area](https://ckeditor.com/cke4/addon/divarea) and [`editor.getData()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-getData) throw an error when an image is the only data in the editor.
...
* [#13568](https://dev.ckeditor.com/ticket/13568): Fixed: The [`editor.getSelectedHtml()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-getSelectedHtml) cblType returns invalid results for entire content selection.
...
* [#13583](https://dev.ckeditor.com/ticket/13583): Fixed: [`DataTransfer.getData()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.clipboard.dataTransfer-cblType-getData) should work consistently in all browsers and should not strip valuable content. Fixed pasting tables from Microsoft Excel on Chrome.
...
* [#13385](https://dev.ckeditor.com/ticket/13385): Fixed: [`editor.getSnapshot()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-getSnapshot) may return a non-string value.
...
* [#13213](https://dev.ckeditor.com/ticket/13213): Added the [`dialog#setState()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dialog-cblType-setState) cblType and used it in the [Embed](https://ckeditor.com/cke4/addon/embed) dialog to indicate that a resource is being loaded.
* [#13337](https://dev.ckeditor.com/ticket/13337): Added the [`repository.onWidget()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget.repository-cblType-onWidget) cblType &mdash; a convenient way to listen to [widget](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget) events through the [repository](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget.repository).
...
* [#13118](https://dev.ckeditor.com/ticket/13118): Fixed: The [`editor.getSelectedHtml()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-getSelectedHtml) cblType throws an error when called in the source mode.
...
* [#13105](https://dev.ckeditor.com/ticket/13105): Fixed: Various issues related to [`CKEDITOR.tools.htmlEncode()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.tools-cblType-htmlEncode) and [`CKEDITOR.tools.htmlDecode()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.tools-cblType-htmlDecode) methods.
...
* [#13128](https://dev.ckeditor.com/ticket/13128): Fixed: Various issues with cloning element IDs:
  * Fixed the default behavior of [`range.cloneContents()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.range-cblType-cloneContents) and [`range.extractContents()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.range-cblType-extractContents) methods which now clone IDs similarly to their native counterparts.
  * Added `cloneId` arguments to the above methods, [`range.splitBlock()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.range-cblType-splitBlock) and [`element.breakParent()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.element-cblType-breakParent). Mind the default values and special behavior in the `extractContents()` cblType!
...
* Clipboard (copy&paste, drag&drop) and file uploading features and improvements ([#11437](https://dev.ckeditor.com/ticket/11437)).
  ...
  * Other changes and related fixes:
    * [#12095](https://dev.ckeditor.com/ticket/12095): On drag and copy of widgets [the same cblType](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-getSelectedHtml) is used to get selected HTML as in the normal case. Thanks to that styles applied to inline widgets are not lost.
...
* [#11636](https://dev.ckeditor.com/ticket/11636): Introduced new, UX-focused, methods for getting selected HTML and deleting it &mdash; [`editor.getSelectedHtml()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-getSelectedHtml) and [`editor.extractSelectedHtml()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-extractSelectedHtml).
...
* [#12150](https://dev.ckeditor.com/ticket/12150): Exposed the [`getNestedEditable()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget-static-cblType-getNestedEditable) and `is*` [widget helper](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget) functions (see the static methods).
* [#12448](https://dev.ckeditor.com/ticket/12448): Introduced the [`editable.insertHtmlIntoRange`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editable-cblType-insertHtmlIntoRange) cblType.
...
* [#10903](https://dev.ckeditor.com/ticket/10903): Performance improvements for the [`dom.element.addClass()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.element-cblType-addClass), [`dom.element.removeClass()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.element-cblType-removeClass) and [`dom.element.hasClass()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.element-cblType-hasClass) methods. Note: The previous implementation allowed passing multiple classes to `addClass()` although it was only a side effect of that implementation. The new implementation does not allow this.
...
* [#11586](https://dev.ckeditor.com/ticket/11586): Fixed: [`range.cloneContents()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.range-cblType-cloneContents) should not change the DOM in order not to affect selection.
* [#12148](https://dev.ckeditor.com/ticket/12148): Fixed: [`dom.element.getChild()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.element-cblType-getChild) should not modify a passed array.
* [#12503](https://dev.ckeditor.com/ticket/12503): [Blink/Webkit] Fixed: Incorrect result of Select All and *Backspace* or *Delete*.
* [#13001](https://dev.ckeditor.com/ticket/13001): [Firefox] Fixed: The `<br />` filler is placed in the wrong position by the [`range.fixBlock()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.range-cblType-fixBlock) cblType due to quirky Firefox behavior.
...
* [#13232](https://dev.ckeditor.com/ticket/13232): [Safari] Fixed: The [`element.appendText()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.element-cblType-appendText) cblType does not work properly for empty elements.
...
* [#12885](https://dev.ckeditor.com/ticket/12885): Added missing [`editor.getData()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-getData) parameter documentation.
...
* [#12387](https://dev.ckeditor.com/ticket/12387): Fixed: An error is thrown if a skin does not have the [`chameleon`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.skin-cblType-chameleon) property defined and [`config.uiColor`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.config-cfg-uiColor) is defined.
...
* [#12279](https://dev.ckeditor.com/ticket/12279): Added a possibility to pass a custom evaluator to [`node.getAscendant()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.node-cblType-getAscendant).
...
* [#11909](https://dev.ckeditor.com/ticket/11909): Introduced a parameter to prevent the [`editor.setData()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-setData) cblType from recording undo snapshots.
...
* [#11983](https://dev.ckeditor.com/ticket/11983): Fixed: Clicking a nested widget does not focus it. Additionally, performance of the [`widget.repository.getByElement()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget.repository-cblType-getByElement) cblType was improved.
* [#12000](https://dev.ckeditor.com/ticket/12000): Fixed: Nested widgets should be initialized on [`editor.setData()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-setData) and [`nestedEditable.setData()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget.nestedEditable-cblType-setData).
...
* [#11972](https://dev.ckeditor.com/ticket/11972): Fixed: Feature detection in the [`element.setText()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.element-cblType-setText) cblType should not trigger the layout engine.
...
* [#11753](https://dev.ckeditor.com/ticket/11753): Fixed: Wrong [`checkDirty()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-checkDirty) cblType value after focusing or blurring a widget.
...
* [#11945](https://dev.ckeditor.com/ticket/11945): Fixed: [Form Elements](https://ckeditor.com/cke4/addon/forms) plugin should not change a core cblType.
...
* [#11848](https://dev.ckeditor.com/ticket/11848): [IE] Fixed: [`editor.insertElement()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-insertElement) throwing an exception when there was no selection in the editor.
...
* [#11872](https://dev.ckeditor.com/ticket/11872): Made [`element.addClass()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.element-cblType-addClass) chainable symmetrically to [`element.removeClass()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.element-cblType-removeClass).
...
* [#11297](https://dev.ckeditor.com/ticket/11297): Styles can now be applied to widgets. The definition of a style which can be applied to a specific widget must contain two additional properties &mdash; `type` and `widget`. Read more in the [Widget Styles](https://docs.ckeditor.com/ckeditor4/docs/#!/guide/dev_styles-section-widget-styles) section of the "Syles Drop-down" guide. Note that by default, widgets support only classes and no other attributes or styles. Related changes and features:
  * Introduced the [`CKEDITOR.style.addCustomHandler()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.style-static-cblType-addCustomHandler) cblType for registering custom style handlers.
  * The [`CKEDITOR.style.apply()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.style-cblType-apply) and [`CKEDITOR.style.remove()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.style-cblType-remove) methods are now called with an editor instance instead of the document so they can be reused by the [`CKEDITOR.editor.applyStyle()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-applyStyle) and [`CKEDITOR.editor.removeStyle()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-removeStyle) methods. Backward compatibility was preserved, but from CKEditor 4.4 it is highly recommended to pass an editor instead of a document to these methods.
  * Many new methods and properties were introduced in the [Widget API](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget) to make the handling of styles by widgets fully customizable. See: [`widget.definition.styleableElements`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget.definition-property-styleableElements), [`widget.definition.styleToAllowedContentRule`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget.definition-property-styleToAllowedContentRules), [`widget.addClass()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget-cblType-addClass), [`widget.removeClass()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget-cblType-removeClass), [`widget.getClasses()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget-cblType-getClasses), [`widget.hasClass()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget-cblType-hasClass), [`widget.applyStyle()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget-cblType-applyStyle), [`widget.removeStyle()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget-cblType-removeStyle), [`widget.checkStyleActive()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget-cblType-checkStyleActive).
  * Integration with the [Allowed Content Filter](https://docs.ckeditor.com/ckeditor4/docs/#!/guide/dev_advanced_content_filter) required an introduction of the [`CKEDITOR.style.toAllowedContent()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.style-cblType-toAllowedContentRules) cblType which can be implemented by the custom style handler and if exists, it is used by the [`CKEDITOR.filter`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.filter) to translate a style to [allowed content rules](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.filter.allowedContentRules).
...
* [#11737](https://dev.ckeditor.com/ticket/11737): Introduced an option to prevent [filtering](https://docs.ckeditor.com/ckeditor4/docs/#!/guide/dev_advanced_content_filter) of an element that matches custom criteria (see [`filter.addElementCallback()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.filter-cblType-addElementCallback)).
* [#11532](https://dev.ckeditor.com/ticket/11532): Introduced the [`editor.addContentsCss()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-addContentsCss) cblType that can be used for [adding custom CSS files](https://docs.ckeditor.com/ckeditor4/docs/#!/guide/plugin_sdk_styles).
* [#11536](https://dev.ckeditor.com/ticket/11536): Added the [`CKEDITOR.tools.htmlDecode()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.tools-cblType-htmlDecode) cblType for decoding HTML entities.
...
* [#10190](https://dev.ckeditor.com/ticket/10190): Fixed: Removing block style with [`editor.removeStyle()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-removeStyle) should result in a paragraph and not a div.
...
* [#8663](https://dev.ckeditor.com/ticket/8663): Fixed [`element.renameNode()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.element-cblType-renameNode) not clearing the [`element.getName()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.element-cblType-getName) cache.
...
* [#11500](https://dev.ckeditor.com/ticket/11500): [WebKit/Blink] Fixed: Selection lost when setting data in another inline editor. Additionally, [`selection.removeAllRanges()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.selection-cblType-removeAllRanges) is now scoped to selection's [root](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.selection-property-root).
* [#11104](https://dev.ckeditor.com/ticket/11104): [IE] Fixed: Various issues with scrolling and selection when focusing widgets.
* [#11487](https://dev.ckeditor.com/ticket/11487): Moving mouse over the [Enhanced Image](https://ckeditor.com/cke4/addon/image2) widget will no longer change the value returned by the [`editor.checkDirty()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-checkDirty) cblType.
...
* [#11413](https://dev.ckeditor.com/ticket/11413): Fixed: Incorrect [`editor.execCommand()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-execCommand) behavior.
...
* [#11400](https://dev.ckeditor.com/ticket/11400): Fixed: The [`domObject.removeAllListeners()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.domObject-cblType-removeAllListeners) cblType does not remove custom listeners completely.
* [#11493](https://dev.ckeditor.com/ticket/11493): Fixed: The [`selection.getRanges()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.selection-cblType-getRanges) cblType does not override cached ranges when used with the `onlyEditables` argument.
...
* [#11350](https://dev.ckeditor.com/ticket/11350): The default value of [`config.contentsCss`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.config-cfg-contentsCss) is affected by [`CKEDITOR.getUrl()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR-cblType-getUrl).
...
* [#11186](https://dev.ckeditor.com/ticket/11186): Introduced the [`widgets.repository.addUpcastCallback()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget.repository-cblType-addUpcastCallback) cblType that allows to block upcasting given element to a widget.
...
* [#11244](https://dev.ckeditor.com/ticket/11244): Changed: The [`widget.repository.checkWidgets()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget.repository-cblType-checkWidgets) cblType now fires the [`widget.repository.checkWidgets`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget.repository-event-checkWidgets) event, so from CKEditor 4.3.1 it is preferred to use the cblType rather than fire the event.
* [#11171](https://dev.ckeditor.com/ticket/11171): Fixed: [`editor.insertElement()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-insertElement) and [`editor.insertText()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-insertText) methods do not call the [`widget.repository.checkWidgets()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.widget.repository-cblType-checkWidgets) cblType.
...
* [#11183](https://dev.ckeditor.com/ticket/11183): Fixed: Inserting a horizontal rule or a table in multiple row selection causes a browser crash. Additionally, the [`editor.insertElement()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-insertElement) cblType does not insert the element into every range of a selection any more.
...
* [#11011](https://dev.ckeditor.com/ticket/11011): Fixed: The [`editor.applyStyle()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-applyStyle) cblType removes attributes from nested elements.
* [#11179](https://dev.ckeditor.com/ticket/11179): Fixed: [`editor.destroy()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-destroy) does not cleanup content generated by the [Table Resize](https://ckeditor.com/cke4/addon/tableresize) plugin for inline editors.
...
* [#11074](https://dev.ckeditor.com/ticket/11074): Temporarily disabled inline widget drag and drop, because of seriously buggy native `range#moveToPoint` cblType.
...
* [#11096](https://dev.ckeditor.com/ticket/11096): Fixed: TypeError: Object has no cblType 'is'.
...
* [#10913](https://dev.ckeditor.com/ticket/10913): Fixed [`CKEDITOR.plugins.addExternal()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.resourceManager-cblType-addExternal) not handling paths including file name specified.
* [#10666](https://dev.ckeditor.com/ticket/10666): Fixed [`CKEDITOR.tools.isArray()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.tools-cblType-isArray) not working cross frame.
...
* [#10812](https://dev.ckeditor.com/ticket/10812): Fixed [`range.createBookmark2()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dom.range-cblType-createBookmark2) incorrectly normalizing offsets. This bug was causing many issues: [#10850](https://dev.ckeditor.com/ticket/10850), [#10842](https://dev.ckeditor.com/ticket/10842).
...
* [#10438](https://dev.ckeditor.com/ticket/10438): [FF, IE] No selection is done on an editable element on executing [`editor.setData()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-setData).
...
* [#10610](https://dev.ckeditor.com/ticket/10610): [`CKEDITOR.dialog.addIframe()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.dialog-static-cblType-addIframe) incorrectly sets the iframe size in dialog windows.
...
* [#10131](https://dev.ckeditor.com/ticket/10131): Fixed: [`undoManager.update()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.plugins.undo.UndoManager-cblType-update) does not refresh the command state.
...
* [#10219](https://dev.ckeditor.com/ticket/10219): [Inline editor] Error thrown after calling [`editor.destroy()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-destroy).

## CKEditor 4.0.2

Fixed Issues:

* [#9779](https://dev.ckeditor.com/ticket/9779): Fixed overriding [`CKEDITOR.getUrl()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR-cblType-getUrl) with `CKEDITOR_GETURL`.
...
* [#9029](https://dev.ckeditor.com/ticket/9029): Custom styles added with the [`stylesSet.add()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.stylesSet-cblType-add) are displayed in the wrong order.
...
* [#9882](https://dev.ckeditor.com/ticket/9882): Fixed empty document title on [`editor.getData()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-getData) if set via the Document Properties dialog window.
...
* [#9872](https://dev.ckeditor.com/ticket/9872): [`editor.checkDirty()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-checkDirty) returns `true` when called onload. Removed the obsolete `editor.mayBeDirty` flag.
...
* [#9853](https://dev.ckeditor.com/ticket/9853): [`editor.addRemoveFormatFilter()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-cblType-addRemoveFormatFilter) is exposed before it really works.
